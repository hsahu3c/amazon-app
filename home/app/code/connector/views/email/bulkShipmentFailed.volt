                                ...
                                <tr>
                                    <td width="100%"
                                        ...
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;">
                                            <?php echo $t4;?> <?= ucfirst($target_marketplace) ?> <?php echo $t5;?>
                                            <?= ucfirst($source_marketplace) ?>. <?php echo $t6;?>
                                        </span>
                                        <span
                                        ...
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            ...
                                            <?php echo $t10;?>  <a href="mailto:channel-support@cedcommerce.com"
                                                color="#2C6ECB"><?php echo $t11;?></a>.
                                        </span>
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333; margin-top: 10px;">
                                        </span>
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%"
                                ...
                                <tr>
                                    <td width="100%"
                                        ...
                                        class="mob-paddding"> <?php echo $t12;?>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="100%"
                                        ...
                                        class="mob-paddding">
                                        <span style="font-weight: 600;"><?php echo $t13;?></span>
                                        <br />
                                        <br />
                                    </td>
                                </tr>
