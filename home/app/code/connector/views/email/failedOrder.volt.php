                        ...
                        <tbody>
                                        ...
                                        <tbody>
                                            <tr style="text-align:center ">
                                                <td style="display:table-cell; ">
                                                    <img src="https://i.imgur.com/AWET5IM.png " style="width: 100%;max-width: 93px; " alt="Report Icon">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-size:26px;line-height:32px;padding-top: 12px;color: #333333;text-align: center; ">
                                                    Order Couldn’t Sync To Shopify Store 
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <tr style=" background: #fff; display: inline-block; padding:32px 0 0; border-top-left-radius: 8px; border-top-right-radius: 8px; ">
                                <td style="font-size: 14px; line-height: 20px; color: #333333; display: inline-block; background-color: #fff; padding:0 32px; " class="mob-paddding ">
                                    <span style="display:block;padding-bottom: 30px;text-align: left;font-weight: 600; ">Hi there,</span>
                           ...
                           We hope you are doing great and in good spirits. Thanks for your continued support to the app.
                           </span>
                                </td>
                            </tr>
                            <tr style="text-align:left">
                                <td style="font-size: 14px; line-height: 20px;color: #333333; background-color: #fff; padding: 0px 32px 20px; " class="mob-paddding ">
                                    <span style="padding-bottom:20px;display:inline-block;text-align: left; ">
                                        We recently received your <?= $source_marketplace ?> order. However, this order couldn’t sync to your <?= $target_marketplace ?> account.
                           </span>                                                               
                                </td>
                            </tr>
                            <tr style="text-align:left">
                                <td style="font-size: 14px; line-height: 20px; color: #333333; display:block; background-color: #fff; padding: 0px 32px 24px;" class="mob-paddding">
                                    <table cellspacing="0" cellpadding="0" style="padding: 20px; border: 1px solid #eee;border-radius: 8px;color:#202223;text-align: left;    font-size: 14px;">                   
                                      <tr>
                                        <td style="font-size:14px;font-weight:600;line-height:20px;    min-width: 230px;" class="width-unset"><?= $source_marketplace ?> Order ID</td>
                            ...
                            <tr style="text-align:left">
                                <td style="font-size: 14px; line-height: 20px; color: #333333; display: inline-block; background-color: #fff; padding: 0px 32px 24px; " class="mob-paddding ">
                                    To get more details you’ll need to go to the “Failed Orders” section of the <?= $app_name ?> app, where you’ll be able to find all the necessary details of this Order. 
                                </td>
                            </tr>
                            <tr style="text-align:left">
                                <td style="font-size: 14px; line-height: 20px; color: #333333; display: inline-block; background-color: #fff; padding: 0px 32px 24px; " class="mob-paddding ">
