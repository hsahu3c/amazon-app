...
<body width="100%" style="margin: 0; text-align: center; background-color: #fff">
  <table cellspacing="0" cellpadding="0" border="0" width="100%" bgcolor="#F6F6F7" align="center " style="
        font-family: 'Roboto', sans-serif;
    ...
    <tbody>
            ...
            <tbody>
                    ...
                    <tbody>
                      <tr style="text-align: center">
                        <td style="display: table-cell">
                          <img src="https://i.imgur.com/bGfCREl.png" style="width: 100%; max-width: 93px" />
                        </td>
                      </tr>
                      <tr>
                        <td style="
              ...
              <tr style="
                ...
                <td style="
                  ...
                  <span style="
                        ...
                        padding-bottom: 20px;
                      " class="mob-padding1">
                    We need your immediate attention regarding your refund
                    order that has failed to sync from
                    <?= $target_marketplace ?> to <?= $source_marketplace ?>.
                  </span>
                </td>
              </tr>
              ...
              <tr style="text-align: left">
                <td style="
                      ...
                      padding: 0px 32px 24px;
                    " class="mob-paddding">
                  To get more details you’ll need to go to the app, where you’ll be
                  able to find all the necessary details of this Order.
                </td>
              </tr>
              <tr style="text-align: left">
                <td style="
                      ...
                      padding: 0px 32px;
                    " class="mob-paddding">
                  To resolve this issue, you can go inside the app
                </td>
              </tr>
              <tr style="text-align: left">
                <td style="
                      ...
                      padding: 0px 32px;
                    " class="mob-paddding">
                  If you need further assistance in the matter, connect with
                  us here:
                </td>
              </tr>
              <tr style="text-align: left">
                <td style="
                      ...
                      padding: 0px 32px 24px;
                    " class="mob-paddding">
                  <a href="mailto:channel-support@cedcommerce.com" style="color: #2c6ecb">Contact Us</a>
                </td>
              </tr>
              <tr style="text-align: left">
                <td style="
      ...
      <tr>
        <td>
          <!-- email footer starts -->
          <table cellspacing="0" cellpadding="0" border="0 " width="640" bgcolor="#F6F6F7" class="email-container" style="
                margin: auto;
      ...
      <tr>
        <td>
          <!-- email content ends -->
          <table cellspacing="0" cellpadding="0" border="0" width="640" bgcolor="#F6F6F7" class="email-container pt-0" style="
                margin: auto;
                padding: 0 64px 34px;
                color: #6d7175;
                line-height: 20px;
