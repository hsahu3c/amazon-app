...
<head>
    ...
    <title>Credit consumed 90</title>
                    ...
                    <tr>
                        <td class="mob-paddding" style="padding-left: 20px;padding-right: 20px;background: #F6F6F7;">
                            ...
                            <table style="background-color: #F6F6F7; margin-left: auto; margin-right: auto;"
                                ...
                                <tr>
                                    <td width="100%"
                                        style="font-size:22px;line-height:32px;padding: 12px 18px 20px 18px; color: #202223;text-align: center ; font-weight: 400;"
                                        class="subject-title">
                                        You’re at 90% of Your Order Usage Cap – Action Recommended
                                    </td>
                                </tr>
                            </table>
                            <table>
                                <tr>
                                    <td style="background: #ffffff;padding: 32px;border-radius: 8px;"
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%" style="border: 0;">
                                            <tr>
                                                <td
                                                    style="font-size: 14px;line-height: 20px;color: #202223;font-weight: 600;padding-bottom: 20px;">
                                                    Hello {{ name }},
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="font-size: 14px;line-height: 20px;color: #202223;padding-bottom: 16px;">
                                                    <!-- Great news! Your business is growing, and so are your sales! As a
                                                    result,  you’ve reached the <b>90% limit of your additional order cap
                                                    amount</b> for the {{ app_name }}. -->
                                                    Your sales are growing — and you've now reached <b>90%</b> of your additional usage cap on the <b>{{ app_name }}</b>.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="font-size: 14px;line-height: 20px;color: #202223;padding-bottom: 8px;">
                                                    <b>What this means:</b><br>
                                                    Once you hit 100% of the cap, order syncing will pause until your next billing cycle. To avoid disruption, we recommend <a href="{{ page_link }}" color="#2C6ECB">upgrading your plan</a> now.
                                                    <!-- Here’s what it means: Once you hit 100% of the cap limit, <b>order
                                                        syncing will pause</b> until your next plan renewal period. You
                                                    must
                                                    either <b>upgrade to a new plan</b> for uninterrupted order
                                                    management or
                                                    wait for your plan to reset next month. -->
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="font-size: 14px;line-height: 20px;color: #202223;padding-top: 8px;padding-bottom: 4px;font-weight: 600;">
                                                    Your Current Plan Details:
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 14px;line-height: 20px;color: #202223;">
                                                    <b>Subscription Plan:</b> {{ plan_details['title'] }} – ${{ plan_details['custom_price'] }} with {{ plan_details['description'] }}
                                                </td>
                                            </tr>
                                            <!-- <tr>
                                                <td style="font-size: 14px;line-height: 20px;color: #202223;">
                                                    <b>Additional Order Limit:</b> {{ capped_data['available_orders'] }} orders at ${{ capped_data['per_unit_usage'] }}per order
                                                </td>
                                            </tr> -->
                                            <tr>
                                                <td style="font-size: 14px;line-height: 20px;color: #202223;">
                                                    <b>Balance Used:</b> ${{ used_balance }} of ${{ capped_data['capped_amount'] }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="font-size: 14px;line-height: 20px;color: #202223;padding-top: 16px;">
                                                    If you're outgrowing your current plan, upgrading will ensure uninterrupted operations.
                                                </td>
                                            </tr>
                                            <!-- <tr>
                                                <td>
                                                    <a href= "{{ page_link }}"
                                                        style="font-size: 14px;line-height: 20px;color: #005BD3;padding-bottom: 8px;"
                                            ...
                                            <tr>
                                                <td
                                                    style="font-size: 14px;line-height: 20px;color: #202223;padding-bottom: 8px;padding-top: 16px;">
                                                    Need help or want to upgrade your plan? <a href="{{ support_page }}" color="#2C6ECB">Contact us here</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
