...
<head>
    ...
    <title>70% of your order credits used</title>
                                        ...
                                        <table style="background-color: #F6F6F7; margin-left: auto; margin-right: auto;"
                                            ...
                                            <tr>
                                                <td width="100%" style="text-align: center;">
                                                    <img src="https://multiamazon-mail-images.s3.us-east-2.amazonaws.com/Images/limit_70.png" style="width: 100%; max-width: 200px;">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="100%"
                                                    style="font-size:26px;line-height:32px;padding-top: 12px;padding-bottom: 20px; color: #333333;text-align: center">
                                                    You’ve used 70% of your Order Limit </td>
                                            </tr>
                                ...
                                <tr>
                                    <td width="100%"
                                        ...
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                                color: #333333;"> We’d like to thank you for using our product and hope we’ve made a difference for you. </span>
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;margin-top: 10px;"> We have noticed that you have <b>used 70% of your order credits,</b>
                                            and we wanted to remind you that the credits will be exhausted soon.
                                        </span>
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                        ...
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;margin-top: 10px;">We understand how important our app is to your business and we want to make sure that you have the necessary credits to continue using our services without any interruption.
                                        </span>
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;margin-top: 10px;">Therefore, we would like to suggest that you consider upgrading the subscription plan to avoid any inconvenience.
                                        </span>
                                    </td>
                                </tr>
                            </table>
                                        ...
                                        <table width="100%" style="background-color: #F1F8F5; border-radius: 8px;">
                                            ...
                                            <tr>
                                                <td width="100%" style="padding: 20px 20px 0;">
                                                    <span
                                                        style="font-weight: 600; font-size: 16px; line-height: 24px; margin-bottom: 4px; color: #202223; display: block;">Upgrade Plan</span>
                                                    <span
                                                        style="font-weight: 400; font-size: 14px; line-height: 20px; color: #202223;">Avoid Excess Usage Charge by upgrading to a more suitable plan. This offer is valid till no Excess Usage Charge amount is generated.</span>
                                                </td>
                                            </tr>
                                            <tr>
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%"
                                ...
                                {% if postpaid_enabled %} <tr>
                                    ...
                                    <td width="100%"
                                        ...
                                        class="mob-paddding"> For any query or further assistance regarding the
                                        subscription
                                        plan or the
                                        exceeded orders, please get in touch with us <a href="{{ support_page }}"
                                            color="#2C6ECB">here</a>.
                                    </td>
                                </tr>
                                <tr>
