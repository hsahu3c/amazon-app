...
<head>
    ...
    <title>50% of your order credits used</title>
                                        ...
                                        <table style="background-color: #F6F6F7; margin-left: auto; margin-right: auto;"
                                            ...
                                            <tr>
                                                <td width="100%" style="text-align: center;">
                                                    <img src="https://multiamazon-mail-images.s3.us-east-2.amazonaws.com/Images/limitexceed.png"  style="width: 100%; max-width: 125px;">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="100%"
                                                    style="font-size:26px;line-height:32px;padding-top: 12px;padding-bottom: 20px; color: #333333;text-align: center">
                                                    You have used 50% of order credits </td>
                                            </tr>
                                ...
                                <tr>
                                    <!-- <td width="100%"
                                        ...
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                                color: #333333;"> We’d like to thank you for using our product and hope
                                            we’ve made a difference for you. </span>
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;margin-top: 10px;"> Based on your order credits on the {{
                                            app_name }}, you have consumed the <b>50% limit of your current {% if
                                                plan_details['code'] === 'trial' %} one-time free trial{% endif %}
                                                plan</b>.
                                        </span>
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                        ...
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;margin-top: 10px;"> To ensure a seamless and uninterrupted
                                            experience while using the app, consider upgrading to a higher
                                            plan {% if
                                                postpaid_enabled %} or paying for the exceeded orders{% endif %}.
                                        </span>
                                    </td> -->
                                    ...
                                    <td width="100%"
                                        ...
                                        <!-- <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                                color: #333333;">
                                                Thank you for choosing our product — we hope it has truly made a difference for you!
                                            </span> -->

                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;margin-top: 10px;"> 
                                            You’ve reached 50% of your order limit under the <b></b>{% if
                                                plan_details['code'] === 'trial' %} one-time free trial {% else %} {{
                                                    plan_details['title'] }} {% endif %} plan</b> on the {{ app_name }}.
                                        </span>
                                        <!-- <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;margin-top: 10px;"> Your current subscription details - <b>({{
                                                plan_details['title'] }} - ${{ plan_details['custom_price'] }}
                                                with {{
                                                plan_details['description'] }})</b>. </span> -->
                                        <!-- <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%"
                                ...
                                {% if postpaid_enabled %} <tr>
                                    <td width="100%"
                                        ...
                                        <b>Note:</b>
                                            <i>
                                                <!-- After exhausting your plan's order limit, each additional order will be charged at ${{ capped_data['per_unit_usage'] }}, up to a maximum of ${{ capped_data['capped_amount'] }}. -->
                                                Once your plan’s limit is fully used, additional orders will be charged at <b>${{ capped_data['per_unit_usage'] }}/order</b> capped at ${{ capped_data['capped_amount'] }}.
                                            </i>
                                            {% else %}
                                            <b>Note:</b>
                                    ...
                                    <td width="100%"
                                        ...
                                        class="mob-paddding">For any queries or support, <a href="{{ support_page }}"
                                            color="#2C6ECB">submit a ticket here</a>.
                                    </td>
                                </tr>
                                <tr>
                                    <td width="100%"
