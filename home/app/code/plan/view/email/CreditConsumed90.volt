...
<head>
    ...
    <title>90% of your order credits used</title>
                                        ...
                                        <table style="background-color: #F6F6F7; margin-left: auto; margin-right: auto;"
                                            ...
                                            <tr>
                                                <td width="100%"
                                                    ...
                                                    You’ve used 90% of your Order Limit </td>
                                            </tr>
                                ...
                                <tr>
                                    <td width="100%"
                                        ...
                                        <!-- <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;"> Thank you for using the {{ app_name }} – we hope you
                                            enjoy this
                                            experience. Just letting you know that you have <b>consumed 90% of your
                                                in-app
                                                order credits</b> and are at the risk of running out of the remaining
                                            credits soon.
                                        </span>
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                        ...
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;margin-top: 10px;">Before it gets any late and you lose out
                                            on our amazing services, we advise you to upgrade the subscription plans as
                                            soon as possible.
                                        </span> -->

                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;">
                                            <!-- Thank you for using {{ app_name }} — we hope you're enjoying the experience! -->
                                            You’ve used <b>90%</b> of your order limit on the <b>{{
                                                plan_details['title'] }} </b> plan (${{ plan_details['custom_price'] }}, {{
                                                    plan_details['description'] }})
                                        </span>
                                        <!-- <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;"> <b>An important heads-up:</b> You've used <b>90% of the order limit</b> of your current plan.
                                        </span> -->
                                        <!-- <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;margin-top: 10px;"> Your current subscription plan - <b>({{
                                                plan_details['title'] }} - ${{ plan_details['custom_price'] }}
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%"
                                    ...
                                    <td width="100%"
                                        ...
                                        <b>Reminder:</b>
                                            <i>
                                                ...
                                                Once the limit is crossed, additional orders will be charged at <b>${{ capped_data['per_unit_usage'] }}/order</b>, capped at ${{ capped_data['capped_amount'] }}.
                                            </i>
                                            {% else %}
                                            <b>Note:</b>
                                ...
                                <tr>
                                    ...
                                    <!-- <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                        ...
                                        Before it gets any late and you lose out
                                        on the sync services, we advise you to upgrade the subscription plans as
                                        soon as possible or you can wait until the renewal of the limits for the next month.
                                </td>
                                </tr>
                                {% endif %}
                                <tr>
