...
<body bgcolor="#eeeeee" width="100%" style="margin:0;">
    ...
    <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="600" style="margin:auto;" class="email-container">
        ...
        <tbody>
            ...
            <tr>
                <td style="padding:20px 30px;font-size:14px;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:22px;color:#666666;">We would like to bring your notice that you have exceeded your plan limit as per your transaction and order history on the <?= $sender ?>.<br ><br>We would advise you to upgrade to another subscription plan or pay for the exceeded orders at the earliest to avoid facing troubles while using our app.<br><br>You can check all details of your subscription plan from your overview page by <a href="<?= $app_url ?>">clicking here.</a></td>
            </tr>
            <tr>
                <td style="padding: 10px 32px;font-size:14px;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:22px;color:#666666;">Thanks and Regards,<br><br> Team CedCommerce
                </td>
            </tr>
            <!-- main content ends -->
        </tbody>
