                    ...
                    <tr>
                        <td width="100%" class="mob-paddding"
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%"
                                        ...
                                        <table style="background-color: #F6F6F7; margin-left: auto; margin-right: auto;"
                                            ...
                                            <tr>
                                                <td width="100%" style="text-align: center;">
                                                    <img src="https://multiamazon-mail-images.s3.us-east-2.amazonaws.com/Images/syncstopped.png">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="100%"
                                                    style="font-size:26px;line-height:32px;padding-top: 12px;padding-bottom: 20px; color: #333333;text-align: center">
                                                    {% if has_settlement_invoice %}
                                                    Action Required: Your Plan Has Been Paused
                                                    {% else %}
                                                    Important Update: Panel Access is Revoked due to plan expiry
                                                    {% endif %}</td>
                                            </tr>
                                ...
                                <tr>
                                    <td width="100%"
                                        ...
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;">
                                            {% if has_settlement_invoice %}
                                            We regret to inform you that you have used all your credits including Excess
                                            order credits which app fetches.
                                            {% else %}
                                            We regret to inform you that your free plan has expired as of <b>{{ date
                                                }}</b>,
                                            so
                                            your panel access has been restricted.
                                            {% endif %}
                                        </span>
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;margin-top: 10px;">{% if has_settlement_invoice %}
                                            Excess Usage Charges are due. As a result, your order syncing has been
                                            stopped
                                            from Amazon to Shopify, and you will only be able to use our services once
                                            the
                                            balance will be settled.
                                            {% else %}
                                            To regain full access to the panel and enjoy the benefits of our platform,
                                            we invite you to consider upgrading to one of our premium plans.
                                            {% endif %}
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td width="100%"
                                        style=" background-color: #fff; padding:0px 32px 16px;border-radius: 8px 8px 0 0;"
                                        class="mob-paddding">
                                        <b>
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;">
                                            The details of your Excess Usage Charge invoice are as follows:
                                        </span>
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;margin-top: 10px;">
                                            Excess Usage Charge Amount: ${{ settlement_invoice['settlement_amount'] }}
                                        </span>
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;margin-top: 10px;">
                                        ...
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;margin-top: 10px;">
                                            Please note that until your Excess Usage Charges are paid in full, your
                                            order credits will not be renewed. We highly recommend that you settle your
                                            outstanding balance as soon as possible to avoid any potential interruptions
                                            to your service.
                                        </span>
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;margin-top: 10px;">
                                            To pay your Excess Usage Charge, please log in to app, or you can pay now
                                            from
                                            here:
                                            <a href="{{settlement_link}}">Pay Now</a>
                                        </span>
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;margin-top: 10px;">
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%"
                                ...
                                <tr>
                                    <td width="100%"
                                        ...
                                        class="mob-paddding"> For any query or further assistance regarding the subscription plan or the exceeded
                                        orders, please get in touch with us <a href="{{ support_page }}"
                                            color="#2C6ECB">here</a>.
                                    </td>
                                </tr>
                                <tr>
                                    <td width="100%"
                                        ...
                                        class="mob-paddding"> 
                                        Thank you for choosing us as your business partner. We appreciate your trust and
