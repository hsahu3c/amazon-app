                                ...
                                <tr>
                                    <td width="100%"
                                        ...
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            ...
                                            of <b>${{ price }}</b> made towards <b>{{ payment_name }}</b> is successfully received. We appreciate your prompt payment and look forward to serving you more in future.
                                        </span>
                                    </td>
                                </tr>
                            </table>
                            <table cellspacing="0" cellpadding="0" width="100%"
                                ...
                                <tr>
                                    <td width="100%"
                                        ...
                                        class="mob-paddding"> If you have any questions about your payment or our services, feel free to reach out to our  <a href="{{ support_page }}"
                                            color="#2C6ECB">customer support team.</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="100%"
