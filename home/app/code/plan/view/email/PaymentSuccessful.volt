                                        ...
                                        <table style="background-color: #F6F6F7; margin-left: auto; margin-right: auto;"
                                            ...
                                            <tr>
                                                <td width="100%" style="text-align: center;">
                                                    <img src="https://multiamazon-mail-images.s3.us-east-2.amazonaws.com/Images/paymentsuccess.png">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="100%"
                                ...
                                <tr>
                                    <td width="100%"
                                        ...
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;">
                                            This is to confirm that a payment of <b>${{ price }}</b> was successfully processed on 
                                            <b>{{date}}</b> for the <b>{{ plan_name }} plan</b> of the <b>{{ app_name
                                                }}</b>.
                                        </span>
                                        <span style="text-align:left;font-size:14px;line-height:20px;display: block; font-family: 'Roboto', sans-serif;
                                            color: #333333;margin-top: 10px;">You can now enjoy seamless order syncing from Amazon to Shopify, valid until the complete usage of your plan’s order limit (including any additional usage).
                                        </span>
                                    </td>
                                </tr>
                            </table>
                            <table cellspacing="0" cellpadding="0" width="100%"
                                ...
                                <tr>
                                    <td width="100%"
                                        ...
                                        class="mob-paddding">If you have any questions or need assistance regarding your plan or order limits, feel free to reach out to us through our support portal:<a href="{{ support_page }}"
                                            color="#2C6ECB">Submit a Ticket</a>.
                                    </td>
                                </tr>
                                <tr>
                                    <td width="100%"
