                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%" style="border: 0;">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <!-- We've detected an issue with your Amazon seller account in <b>{{country}}</b> marketplace. This requires your immediate attention. Don't worry, it's likely due to either an expired authorization token or restricted access.

                                                    However, until the issue is resolved, all automated syncing actions between our app and your account—including order, shipment, product, inventory, and price sync, etc—have been temporarily paused. -->
                                                    We’ve identified an issue with your Amazon Seller Account on the  <b>{{country}}</b> marketplace, and it requires your immediate attention.
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    This is typically caused by an <b> expired authorization token</b> or <b>restricted access permissions</b>. As a result, all automated syncing between your Amazon account and the {{ app_name }} — including orders, products, inventory, and pricing—has been temporarily paused.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="font-size: 14px;line-height: 20px;color: #202223;padding-top: 8px;padding-bottom: 8px;">
                                                    To resolve the issue and restore syncing, please log in to your account. A banner will appear with complete details and step-by-step instructions for reauthorization:
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
