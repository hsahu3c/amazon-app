...
<body width="100%" style="margin: 0; background-color: #f8e2e2;">
                                ...
                                <tr>
                                    <td width="100%">
                                        <table cellspacing="0" cellpadding="0"
                                            ...
                                            <tr>
                                                <td width="65%"
                                                    style="font-size: 16px;line-height: 20px;color: #570000;font-weight: 400; padding-top: 34px;   padding-left: 12px; text-align: center;"
                                                    class="heading">
                                                    Text Template - Cedcommerce
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%"
                                ...
                                <tr>
                                    <td width="100%"
                                        ...
                                        class="mob-paddding">
                                        <span
                                            style="display:block;padding-bottom: 30px;text-align: left;font-weight: 600;">Hello, </span>
