...
<head>
    ...
    <title>Re-authorize Your Amazon Account</title>
                    ...
                    <tr>
                        <td class="mob-paddding" style="padding-left: 20px;padding-right: 20px;background: #F6F6F7;">
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%" style="border: 0;">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    We've noticed that the Amazon account connected to your {{app_name}} app requires your immediate attention. Due to an expired authorization token, you're currently unable to access certain features of our services.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td  style="font-size: 14px;line-height: 20px;color: #202223;padding-top: 8px;">
                                                    To ensure uninterrupted use of the {{app_name}}, please follow these steps to re-authorize your Amazon account:
                                                </td>
                                            </tr>
                                            <tr>
                                                <td  style="font-size: 14px;line-height: 20px;color: #202223;">
                                                    1. <b>Go to Menu</b> > Partner Network > Manage Your Apps.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 14px;line-height: 20px;color: #202223;">
                                                    2. <b>Locate</b> the "{{app_name}}" app.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 14px;line-height: 20px;color: #202223;">
                                                    3. <b>Click</b> the "Re-authorize" button.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 14px;line-height: 20px;color: #202223;padding-bottom: 8px;">
                                                    4. <b>Follow</b> the on-screen instructions to grant the necessary permissions.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 14px;line-height: 20px;color: #202223;padding-top: 8px;padding-bottom: 8px;">
                                                    Please note: Download the CSV file attached below to check for any inactive accounts that may require re-authorization.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="font-size: 14px;line-height: 20px;color: #202223;padding-top: 8px;">
                                                    If you need any further assistance or is unable to resolve the
                                                    issue, connect with us
                                                </td>
                                            </tr>
                                            <tr>
                            ...
                            <table cellspacing="0" cellpadding="0" width="100%" class=" pt-0"
                                ...
                                <!-- <tr>
                                    <td width="100%"
                                        style="color:#6D7175;line-height:20px;padding:20px;text-align:center;font-size: 14px;">
                                        If you need any assistance, check out the extensive <a href="#" target="_blank"
                                            style="color: #2C6ECB;">self-help section</a> for quick resolution.
                                        If you’d rather not receive this kind of email, you can <a href="#"
                                            target="_blank" style="color: #2C6ECB;">unsubscribe or manage
