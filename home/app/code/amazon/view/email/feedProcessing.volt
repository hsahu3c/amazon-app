                            ...
                            <table style="background-color: #F6F6F7; margin-left: auto; margin-right: auto;"
                                ...
                                <tr>
                                    <td width="100%" style="text-align: center;">
                                        <img src=".https://multiamazon-mail-images.s3.us-east-2.amazonaws.com/Images/Illustrations.png">
                                    </td>
                                </tr>
                                <tr>
                                    <td width="100%"
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%" style="border: 0;">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    We’re happy to inform you that your recent action has been completed successfully.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="font-size: 14px;line-height: 20px;color: #202223;font-weight: 600;padding-bottom: 6px;">
                                                    Action Details:</td>
                                            </tr>
                                            <tr>
                                                <td style="padding-left: px;"><span
                                                        style="font-size: 14px;line-height: 20px;color: #202223;font-weight: 600;">Action
                                                        Type:</span> <span
                                                        style="font-size: 14px;line-height: 20px;color: #202223;padding-left: 4px;">{{actionType
                                                        }}</span></td>
                                            </tr>
                                            <tr>
                                                <td style="padding-left: px;">
                                                    <span
                                                        style="font-size: 14px;line-height: 20px;color: #202223;font-weight: 600;">Status:</span>
                                                    <span
                                                        style="font-size: 14px;line-height: 20px;color: #202223;padding-left: 4px;">Completed</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-left: px;"><span
                                                        style="font-size: 14px;line-height: 20px;color: #202223;font-weight: 600;">Date
                                                        and Time:</span> <span
                                                        style="font-size: 14px;line-height: 20px;color: #202223;padding-left: 4px;">{{dateAndTime}}</span></td>
                                            </tr>
                                            <tr>
                                                <td style="padding-left: px;"><span
                                                        style="font-size: 14px;line-height: 20px;color: #202223;font-weight: 600;">Products
                                                        Processed Successfully:</span> <span
                                                        style="font-size: 14px;line-height: 20px;color: #202223;padding-left: 4px;">{{responseSucessfull}}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-left: px;"><span
                                                        ...
                                                        style="font-size: 14px;line-height: 20px;color: #202223;padding-left: 4px;">{{errors}}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="font-size: 14px;line-height: 20px;color: #202223;padding-bottom: 8px;padding-top: 8px;">
                                                    Your product and inventory data have been updated based on the action performed. 
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding-left: px;"><span
                                                        style="font-size: 14px;line-height: 20px;color: #202223;font-weight: 600;">
                                                        If you notice any discrepancies or have any questions, feel free to contact our support team here:
