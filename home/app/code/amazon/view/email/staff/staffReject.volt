...
<head>
    ...
    <title>Staff user rejected</title>
                                        ...
                                        <table cellspacing="0" cellpadding="0"
                                            ...
                                            <tr>
                                                <td class="logo" style="text-align: right; padding-top: 20px;"
                                                    width="35%">
                                                    <img src="{{base_url}}/media/logo.png" style="width: 100%;max-width: 24px;">
                                                </td>
                                                <td width="65%"
                            ...
                            <table style="background-color: #F6F6F7; margin-left: auto; margin-right: auto;"
                                ...
                                <tr>
                                    <td width="100%" style="text-align: center;">
                                        <img src="{{base_url}}/media/user-rejected.png">
                                    </td>
                                </tr>
                                <tr>
                                    <td width="100%"
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%" style="border: 0;">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    Sorry! Your request to access the CedCommerce Amazon Channel widget
                                                    on {{seller_name}} Seller Account has been denied by the admin.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="font-size: 14px;line-height: 20px;color: #202223;padding-bottom: 8px;">
                                                    If you have any queries, reach out to the admin or us at <a
                                                        href="mailto:channel-support@cedcommerce.com"
                                                        style="color: #1570EF;">channel-support@cedcommerce.com</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
