                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;" class="">
                                                                    <div style="font-family:open Sans Helvetica, Arial, sans-serif;font-size: 17px;font-weight: 600;line-height:26px;text-align:left;color: #1e2281;" class="">Hello <?= $name ?>,</div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;" class="">
                                                            ...
                                                            <tr>
                                                                <td align="center" style="font-size:0px;/* padding: 0px 25px; */padding-right:25px;padding-left: 25px;word-break:break-word;">
                                                                    <div class=""><a href="<?= $link ?>"></a><button onclick="hello()" style="
    padding: 9px 46px;
    background: #223494;
    border: unset;
    border-radius: 6px;
...
">Click Here</a></button>
                                                            ...
                                                            <tr>
                                                                <td align="left" style="font-size:0px;/* padding: 0px 25px; */padding-right:25px;padding-left:25px;word-break:break-word;" class="">
                                                                    <div style="font-family: serif;font-size: 15px;font-weight: 400;line-height: 24px;text-align:left;color: #322c32;margin-top: 11px;" class="">If you did not request a password reset, please ignore this email or reply to let us know. <b>This password reset link is only valid for the next 24 Hours.</b>
                                                                        <br>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                                                                        ...
                                                                                                                        <tbody>
                                                                                                                            <tr>
                                                                                                                                <td style="font-size:0;height:30px;vertical-align:middle;width:30px;">
                                                                                                                                    <a href="https://www.facebook.com/CedCommerce/" target="_blank">
                                                                                                                                        <img height="30" src="https://www.mailjet.com/images/theme/v1/icons/ico-social/facebook.png" alt="facebook" style="border-radius:3px;display:block;" width="30">
                                                                                                                    ...
                                                                                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#dc4e41;border-radius:3px;width:30px;">
                                                                                                                        <tbody>
                                                                                                                            <tr>
                                                                                                                                <td style="font-size:0;height:30px;vertical-align:middle;width:30px;">
                                                                                                                                    <a href="https://cedcommerce.com/" target="_blank">
                                                                                                                                        <img height="30" src="https://www.mailjet.com/images/theme/v1/icons/ico-social/google-plus.png" alt="google-plus" style="border-radius:3px;display:block;" width="30">
                                                                                                                ...
                                                                                                                <td style="padding:4px;vertical-align:middle;">
                                                                                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#55acee;border-radius:3px;width:30px;">
                                                                                                                        <tbody>
                                                                                                                            <tr>
                                                                                                                                <td style="font-size:0;height:30px;vertical-align:middle;width:30px;">
                                                                                                                                    <a href="https://twitter.com/cedcommerce" target="_blank">
                                                                                                                                        <img height="30" src="https://www.mailjet.com/images/theme/v1/icons/ico-social/twitter.png" alt="twitter" style="border-radius:3px;display:block;" width="30">
                                                                                                                ...
                                                                                                                <td style="padding:4px;vertical-align:middle;">
                                                                                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#0077b5;border-radius:3px;width:30px;">
                                                                                                                        <tbody>
                                                                                                                            <tr>
                                                                                                                                <td style="font-size:0;height:30px;vertical-align:middle;width:30px;">
                                                                                                                                    <a href="https://www.linkedin.com/company/cedcommerce/" target="_blank">
                                                                                                                                        <img height="30" src="https://www.mailjet.com/images/theme/v1/icons/ico-social/linkedin.png" alt="linkedIn" style="border-radius:3px;display:block;" width="30">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                                                    <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:11px;font-weight:400;line-height:16px;text-align:center;color:#445566;">You are receiving this email because you have installed an app by CedCommerce and agreed to receive emails from us regarding new features,
                                                                                                        events and special offers.<br> Company Address: CedCommerce Inc 1812 N Columbia Blvd Suite C15-653026 Portland, Oregon, 97217, USA</div>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
