                                                ...
                                                <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color:#f6f6f6;vertical-align:middle;" width="100%">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;" class="">
                                                                    <div style="font-family: serif;font-weight: 400;line-height:26px;text-align:left;color: #000000;font-size: 16px;" class="">We’d like to confirm that your account was created successfully. <i><strong>To access
                                                                                the app click the link
                                                                                below. This account confirmation link is only valid for the next 7 days.</strong></i></div>
                                                                </td>
                                                            </tr>
                                                            <tr>
