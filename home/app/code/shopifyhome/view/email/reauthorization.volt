...
<head>
    ...
    <title>Reauthorization Required</title>
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%" style="border: 0;">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    We noticed that your {{app_name}} app requires some additional permissions to continue providing you with the best service. To ensure uninterrupted access to all features, we need you to reauthorize the app.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="font-size: 14px;line-height: 20px;color: #202223;padding-bottom: 8px;">
                                                    Please click the button below to update the app permissions and reauthorize access:
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 16px 0; text-align: center;">
                                                    <a href="{{redirect_uri}}" 
                                                       style="display: inline-block; padding: 8px 16px; background-color: #2C6ECB; color: #ffffff; text-decoration: none; border-radius: 4px; font-size: 13px; font-weight: 400;">
