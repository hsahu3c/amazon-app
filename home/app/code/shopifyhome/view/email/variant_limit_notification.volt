...
<head>
    ...
    <title>Action Required: Products with 100+ Variants</title>
                    ...
                    <tr>
                        <td class="mob-paddding" style="padding-left: 20px;padding-right: 20px;background: #F6F6F7;">
                            ...
                            <table style="background-color: #F6F6F7; margin-left: auto; margin-right: auto;"
                                ...
                                <tr>
                                    <td width="100%"
                                        style="font-size:20px;line-height:26px;padding: 20px 40px 16px 40px; color: #202223;text-align: center; font-weight: 500; white-space: nowrap;"
                                        class="subject-title">
                                        {{subject}}
                                    </td>
                                </tr>
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%" style="border: 0;">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    We have identified that <strong>{{count}} product(s)</strong> in your store have a variant count greater than 100. Your current plan does not support products with more than 100 variants.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="font-size: 14px;line-height: 20px;color: #202223;padding-bottom: 8px;">
                                                    These products will be <strong>removed from the app after {{last_date}}</strong> unless you take one of the following actions:
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-size: 14px;line-height: 20px;color: #202223;padding-bottom: 8px;padding-left: 16px;">
                                                    <ul style="margin: 0; padding-left: 16px;">
                                                        <li style="padding-bottom: 4px;">Opt for the <strong>2048 Variant Support</strong> add-on service</li>
                                                        <li style="padding-bottom: 4px;">Upgrade your plan to a premium tier</li>
                                                    </ul>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="font-size: 14px;line-height: 20px;color: #202223;padding-bottom: 8px;">
                                                    If you believe these products should not be removed, please upgrade your plan or activate the 2048 Variant Support service before the above date.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    ...
                                                    <a href="https://support.cedcommerce.com/portal/en/newticket?departmentId=132692000000010772&layoutId=132692000092595993" target="_blank" style="color: #2C6ECB;">Contact Us</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
