...
<head>
    ...
    <title>Customer Requested Data</title>
                            ...
                            <table style="background-color: #F6F6F7; margin-left: auto; margin-right: auto;"
                                ...
                                <tr>
                                    <td width="100%" style="text-align: center;">
                                        <img src="https://multiamazon-mail-images.s3.us-east-2.amazonaws.com/Images/customer_requested_data.png">
                                    </td>
                                </tr>
                                <tr>
                                    <td width="100%"
                                        style="font-size:26px;line-height:32px;padding-top: 12px;padding-bottom: 20px; color: #202223;text-align: center ; font-weight: 400;"
                                        class="subject-title">
                                        {{ subject }} </td>
                                </tr>
                            </table>
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%" style="border: 0;">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <!-- As per requested, please find an attached requested customer data in
                                                    the CSV format. The file contains all the relevant details of the
                                                    orders for your review and records. -->
                                                    As requested, please find the attached customer data in CSV format. The file includes all relevant order details for your review and records.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
