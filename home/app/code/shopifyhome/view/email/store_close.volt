...
<head>
    ...
    <title>App Services Suspended</title>
                                        ...
                                        <table cellspacing="0" cellpadding="0" width="100%" style="border: 0;">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    We noticed that your Shopify store is currently marked as closed, frozen, or inactive. As a result, the services of the {{app_name}} app have been temporarily suspended for your store.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="font-size: 14px;line-height: 20px;color: #202223;padding-bottom: 8px;">
                                                    No worries — once your Shopify store is reactivated, the app’s services will automatically resume, and your Amazon selling operations can continue without disruption.
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
